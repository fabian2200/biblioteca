                                ...
                                <div class="row">
                                    <div class="col-11 col-md-11">
                                        ...
                                        <ul class="media-list p-0">
                                            ...
                                            <li @click="verContenidoVideo(item.contenido_busqueda.id_original, (item.contenido_busqueda.tipo_contenido == 'asignatura' ? 'N' : 'T'), item.contenido_busqueda.ruta)" style="padding-left: 15px; margin-top: 20px;"  v-for="(item, index) in datos" :key="index" class="row item_lista">
...
export default {
    ...
    methods: {
        ...
        verContenidoVideo(id, tipo, ruta){
            debugger
            location.href = "/contenido-video/"+id+"/"+tipo+"/"+ruta;
        }
    }
}
</script>
